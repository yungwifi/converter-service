...
exports.ConverterService = exports.ConversionType = void 0;
var InputTypeEnum;
(function (InputTypeEnum) {
    InputTypeEnum["MARKDOWN"] = "MARKDOWN";
    InputTypeEnum["HTML"] = "HTML";
    InputTypeEnum["INVALID"] = "INVALID";
    InputTypeEnum["PLAIN_TEXT"] = "PLAIN_TEXT";
})(InputTypeEnum || (InputTypeEnum = {}));
var ConversionType;
(function (ConversionType) {
    ConversionType["MARKDOWN"] = "MARKDOWN";
...
class ConverterService {
     ...
     * @param line
     */
    static convertUnformattedText(line) {
        if (line !== '') {
            return `<p>${line}</p>`;
        }
        else {
     ...
     * @param line
     */
    static hasMarkdownHeading(line) {
     ...
     * @param line
     */
    static convertHeadingsToHtml(line) {
        const regex = /^#+/;
